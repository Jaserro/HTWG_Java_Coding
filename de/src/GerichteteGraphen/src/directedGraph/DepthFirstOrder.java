...
public class DepthFirstOrder<V> {
    ...
    private final directedGraph.DirectedGraph<V> myGraph;
     ...
     */
    public DepthFirstOrder(directedGraph.DirectedGraph<V> g) {
        myGraph = g;
        visitDFAllNodes(g);
    }


    private void visitDFAllNodes(directedGraph.DirectedGraph<V> g){
