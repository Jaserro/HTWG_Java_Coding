package Auswertungsbaum.src.auswertungsbaum;//package expressiontree;
...
public class ExpressionTreeApplication {
    ...
    public static void main(String[] args) {
        ...
        Constant three = new Constant(3.0);	// Konstante 3.0
        ...
        // Audruck e4 = a + (b + c)
        Expression e4
                = new Sum(a, new Sum(b, c));	// Vorsicht: Sie müssen e4 noch definieren.
