package ArrayFrequencyTable.src.arrayFrequencyTable;
...
public interface FrequencyTable {
	 ...
	 */
	void addAll(linkedListFrequencyTable.FrequencyTable fq);
	 ...
	 * @param fq H&auml;ufigkeitstabelle.
	 */
	void collectMostFrequent(linkedListFrequencyTable.FrequencyTable fq);
	
	/**
	 * Sammelt alle W&ouml;rter mit der H&auml;ufigkeit 1 und speichert sie in fq.
	 * @param fq H&auml;ufigkeitstabelle.
	 */
	void collectLeastFrequent(linkedListFrequencyTable.FrequencyTable fq);
}
