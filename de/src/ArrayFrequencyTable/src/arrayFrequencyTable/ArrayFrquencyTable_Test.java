...
import linkedListFrequencyTable.ArrayFrequencyTable;
...
public class ArrayFrquencyTable_Test {
	...
	private static void test2() throws FileNotFoundException, IOException {
		...
		LineNumberReader in;
		in = new LineNumberReader(new FileReader("de/ArrayFrequencyTable/Kafka_Der_Prozess.txt"));
		String line;
