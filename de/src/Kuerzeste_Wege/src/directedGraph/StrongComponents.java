...
package Kuerzeste_Wege.src.directedGraph;
...
public class StrongComponents<V> {
	...
	private void KosarajuSharirAlgorithmus(DirectedGraph<V> g) {
		DepthFirstOrder<V> dep = new DepthFirstOrder<>(g);
	...
	private static void test2() throws FileNotFoundException {
		DirectedGraph<Integer> g = readDirectedGraph(new File("src/directedGraph/mediumDG.txt"));
