...
//		FrequencyTable<BlackCard> blackCardTab = new ArrayFrequencyTable<>();
		...
		FrequencyTable<Card> cardTab1 = new LinkedListFrequencyTable<>();
		FrequencyTable<Card> cardTab2 = new LinkedListFrequencyTable<>();
		FrequencyTable<RedCard> redCardTab = new LinkedListFrequencyTable<>();
		FrequencyTable<BlackCard> blackCardTab = new LinkedListFrequencyTable<>();
